...
can import from `versionminus.core.milvus` without depending on the historical
`siphonn.utils.service` package.

Environment / settings are driven exclusively by `versionminus.core.config.Settings`.
"""
