...
from versionminus.core.logging import configure_logging
from fastapi import Depends
from versionminus.api import deps
from versionminus.api.routers import (
    health,
    users,
    threads,
    messages,
...
if settings.auth_enabled:
    ...
    async def auth_middleware(request: Request, call_next):
        ...
        try:
            from versionminus.core.auth import _verify_token  # local import to avoid circular
